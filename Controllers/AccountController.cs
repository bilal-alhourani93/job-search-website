...
namespace Job_search.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            var userId = User.Identity.GetUserId();
            var CurretUser = db.Users.Where(a => a.Id == userId).SingleOrDefault();
            if (!UserManager.CheckPassword(CurretUser, profile.CurrentPassword))
            {
            ...
            else
            {
                ...
                CurretUser.UserName = profile.UserName;
                CurretUser.Email = profile.Email;
                CurretUser.PasswordHash = newPasswordHash;
                db.Entry(CurretUser).State = EntityState.Modified;
                db.SaveChanges();
